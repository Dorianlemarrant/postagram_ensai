...
class GlobalacceleratorEndpointGroupEndpointConfigurationOutputReference(
    ...
    def attachment_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fb41eca9f619d9a020d40d4d0ba14b4ea76ac1c2769f7b80b6a90640f3e1b150)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__fb41eca9f619d9a020d40d4d0ba14b4ea76ac1c2769f7b80b6a90640f3e1b150(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
