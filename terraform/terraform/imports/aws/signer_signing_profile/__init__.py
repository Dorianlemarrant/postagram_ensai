...
@jsii.data_type(
    jsii_type="aws.signerSigningProfile.SignerSigningProfileSigningMaterial",
    jsii_struct_bases=[],
...
class SignerSigningProfileSigningMaterial:
    def __init__(self, *, certificate_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__92b2f74309839092447385069a22778934207e2e74641987d1ca131589c5dbac)
...
class SignerSigningProfileSigningMaterialOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.signerSigningProfile.SignerSigningProfileSigningMaterialOutputReference",
):
    def __init__(
        self,
        terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d86d0011674408437999b677d5470a7aa5ca6c8c888ef401e1c5d44088d20590)
            check_type(argname="argument terraform_resource", value=terraform_resource, expected_type=type_hints["terraform_resource"])
            check_type(argname="argument terraform_attribute", value=terraform_attribute, expected_type=type_hints["terraform_attribute"])
        jsii.create(self.__class__, self, [terraform_resource, terraform_attribute])
    ...
    def certificate_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5fc808438570938097694ab5b744073dac515054ec4a1dbc75cf54d1a3321e7a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e915eaece3161185b8ac6a6a6afe69176849e5d9e513de3e5f1c06ef1ab57d9d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value) # pyright: ignore[reportArgumentType]
...
def _typecheckingstub__92b2f74309839092447385069a22778934207e2e74641987d1ca131589c5dbac(
    *,
...
def _typecheckingstub__d86d0011674408437999b677d5470a7aa5ca6c8c888ef401e1c5d44088d20590(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__5fc808438570938097694ab5b744073dac515054ec4a1dbc75cf54d1a3321e7a(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e915eaece3161185b8ac6a6a6afe69176849e5d9e513de3e5f1c06ef1ab57d9d(
    value: typing.Optional[SignerSigningProfileSigningMaterial],
) -> None:
    """Type checking stubs"""
    pass
