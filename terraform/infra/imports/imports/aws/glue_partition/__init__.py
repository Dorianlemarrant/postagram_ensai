...
class GluePartitionStorageDescriptorOutputReference(
    ...
    def additional_locations(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__46e652e45450df8772137e6f5d75d2026148893b252832882feff995a487d4e5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__46e652e45450df8772137e6f5d75d2026148893b252832882feff995a487d4e5(
    value: typing.List[builtins.str],
) -> None:
    """Type checking stubs"""
    pass
